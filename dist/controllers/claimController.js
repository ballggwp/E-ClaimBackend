...
exports.uploadAttachments = exports.listAttachments = exports.userConfirm = exports.updateSigner = exports.approverAction = exports.updateCpmForm = exports.createCpmForm = exports.ManagerAction = exports.claimAction = exports.updateClaim = exports.getClaim = exports.createClaim = exports.listClaims = void 0;
...
const claimAction = async (req, res, next) => {
    try {
        ...
        const [updatedClaim] = await prisma_1.default.$transaction([
            prisma_1.default.claim.update({
                where: { id },
                data: {
                    status: newStatus,
            ...
            prisma_1.default.claimHistory.create({ data: { claimId: id, status: newStatus } }),
        ]);
...
const ManagerAction = async (req, res, next) => {
    try {
        ...
        const [updated] = await prisma_1.default.$transaction([
            ...
            prisma_1.default.claimHistory.create({
...
const updateCpmForm = async (req, res, next) => {
    try {
        ...
        if (!saveAsDraft) {
            await prisma_1.default.claim.update({
                where: { id: claimId },
                data: {
